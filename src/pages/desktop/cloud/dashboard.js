    ...
    <div className={styles.dashboardLayout}>
      <nav className={styles.dashboardNav}>
        ...
        <ul className={styles.navMenu}>
          <li className={`${styles.navItem} ${router.pathname === '/desktop/cloud/dashboard' ? styles.navItemActive : ''}`}>
          ...
          {expandedSpaces && (
            <>
              <li className={`${styles.navItem} ${router.pathname === '/desktop/cloud/personal' ? styles.navItemActive : ''} ${styles.navSubitem}`}>
                <Link href="/desktop/cloud/personal" legacyBehavior>
                  <a>Личное</a>
                </Link>
              </li>
              <li className={`${styles.navItem} ${router.pathname === '/desktop/cloud/common' ? styles.navItemActive : ''} ${styles.navSubitem}`}>
            ...
            <div className={styles.statCard}>
              ...
              <div className={styles.statsDetails}>
                <div className={styles.storageInfo}>
                  <div className={styles.storageItem}>Использовано: <strong>{(storageStats.used / 1024).toFixed(2)} GB</strong></div>
                  <div className={styles.storageItem}>Свободно: <strong>{(storageStats.free / 1024).toFixed(2)} GB</strong></div>
                  <div className={styles.storageItem}>Всего: <strong>{(storageStats.total / 1024).toFixed(2)} GB</strong></div>
                </div>
